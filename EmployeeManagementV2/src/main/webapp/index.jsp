<%-- 
    Document   : index
    Created on : 5 nov. 2019, 16:17:51
    Author     : Anil DEVADAS
--%>
                    ...
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" name='myform' action="Controller" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name='loginForm' id="username" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label for="password" class="text-info">Password:</label><br>
                                <input type="password" name='pwdForm' id="password" class="form-control" required>
                            </div>
                            <div class="form-group">
